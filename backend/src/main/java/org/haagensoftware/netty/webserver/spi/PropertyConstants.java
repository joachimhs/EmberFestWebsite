...
public class PropertyConstants {
    public static final String NETTY_PORT = "com.embercampeurope.netty.port";
    public static final String WEBAPP_DIR = "com.embercampeurope.netty.webappDir";
    ...
    public static final String PERSONA_AUDIENCE = "eu.emberfest.personaAudience";
}
